...
public class signup extends JFrame{
	...
	private JTextField id_numbertext;
	...
	public signup() {
		...
		id_numbertext.setBounds(97, 112, 180, 33);
		id_numbertext.setColumns(10);
		contentPane.add(id_numbertext);
			...
			public void actionPerformed(ActionEvent e) {
               ...
               // frame.setVisible(true);
				...
				if(e.getSource()==signUp) {
					...
					ad.setId_number(id_numbertext.getText());
